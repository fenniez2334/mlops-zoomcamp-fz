...
* create environment
```
conda create -n deployment-env python=3.9
```
* activate environment
```
conda activate deployment-env
```
...
>My answer:
```
du -h ./output/yellow_2023-03.parquet
66M     ./output/yellow_2023-03.parquet
```
...
>My answer:
```
pipenv install scikit-learn==1.6.1 --python=3.9
...
Mean predicted durations: 14.29
```
